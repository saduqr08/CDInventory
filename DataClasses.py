...
class Track():
    ...
    def position(self, value):
        if type(value) == int:
            ...
            self.__postion = value
             ...
             raise Exception ('Position needs to include an inteerger')
    # Track title         
    @property
    def title(self):
        return self.__title
    ...
    def title(self, value):
        if type (value) == str:
            ...
            raise Exception( 'Title neds to be a string')
    ...
    # -- Methods -- #
    def __str__(self):
         """ Returns the track details as a formatted string"""
         return '{:>2}. {} ({})'.format(self.position, self.title, self.length)
       
    
    def get_record(self) -> str:
        """Returns: Track record formatted to a string"""
